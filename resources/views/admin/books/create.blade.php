                            ...
                            <form action="{{ route('books.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2">
                                    <div class="py-3">
                                        ...
                                        <input class="w-1/3" type="text" name="book_title" placeholder="Book Title" value="{{ old('book_title') }}">
                                    </div>
                                    <div class="py-3">
                                        @error('book_author')
                                            <div class="text-red-400">{{ $message }}</div>
                                        ...
                                        <input class="w-1/3" type="text" name="book_author" placeholder="Book Author" value="{{ old('book_author') }}">
                                    </div>
                                    <div class="py-3">
                                        @error('p_year')
                                            <div class="text-red-400">{{ $message }}</div>
                                        ...
                                        <input class="w-1/3" type="number" name="p_year" placeholder="Publication Year" min='0' value="{{ old('p_year') }}">
                                    </div>
                                    <div class="py-3">
                                        @error('rating')
                                            <div class="text-red-400">{{ $message }}</div>
                                        ...
                                        <input class="w-1/3" type="number" name="rating" min="0" max="5" placeholder="Rating" value="{{ old('rating') }}">
                                    </div>
                                    <div class="py-3">
                                        @error('price')
                                            <div class="text-red-400">{{ $message }}</div>
                                        ...
                                        <input class="w-1/3" type="number" name="price" min="0" placeholder="$ Price" value="{{ old('price') }}">
                                    </div>
                                    <div>
